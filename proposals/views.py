...
class SingleGroup(generic.DetailView):
    model = blog_posts
    template_name = 'proposals/post_join.html'
...
class JoinGroup(LoginRequiredMixin, generic.RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        return reverse("proposals:post_join",kwargs={'pk':self.kwargs.get('pk')})
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.warning(self.request,("Warning, already a member of {}".format(group.Initiative_Title)))

        else:
            messages.success(self.request,"You are now a member of the {} group.".format(group.Initiative_Title))
